...
echo *******************************
echo *                             *
echo *  PETALS AROUND THE ROSE v2  *
...
if not exist diceV2.bat (
	echo DICEv2.BAT missing! Program will now terminate...
	pause
	exit)
...
echo ------- ------- ------- ------- -------
call diceV2.bat d%no1%r1 d%no2%r1 d%no3%r1 d%no4%r1 d%no5%r1
call diceV2.bat d%no1%r2 d%no2%r2 d%no3%r2 d%no4%r2 d%no5%r2
call diceV2.bat d%no1%r3 d%no2%r3 d%no3%r3 d%no4%r3 d%no5%r3
echo ------- ------- ------- ------- -------
